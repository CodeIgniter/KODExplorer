    ...
    var e = "index.php?fav/",
        t = function (t) {
            ...
            if ($("table#list").html(i), "fav&" == t.substring(0, 4)) {
                var s = t.split("&")[1].split("=")[1],
                    o = t.split("&")[2].split("=")[1],
                    r = "<tr class='favlist' name='' path=''>   <td class='name'><input type='text' id='sname' value='" + urlDecode(s) + "' /></td>" + "   <td class='path'><input type='text' id='spath' value='" + urlDecode(o) + "' /></td>" + "   <td class='action'>" + "       <a href='javascript:void(0)' class='button addsave'>" + LNG.button_save + "</a>" + "       <a href='javascript:void(0)' class='button addexit'>" + LNG.button_cancel + "</a>" + "   </td>" + "</tr>";
        ...
        r = function () {
            $(".fav a.add").live("click", a), $(".fav a.addexit").live("click", i), $(".fav a.addsave").live("click", n), $(".fav a.edit").live("click", s), $(".fav a.del").live("click", o)
        };
    return {
        init: t,
        bindEvent: r
    ...
    var e = "index.php?group/",
        ...
        o = function () {
            var t = $(".group_editor #role").val(),
                ...
                s = $(".group_editor #ext_not_allow").val(),
                o = {},
                r = "",
                l = "add";
            if (void 0 == s && (s = ""), "" == t || "" == i) return tips(LNG.not_null, "error"), !1;
            if (escape(t).indexOf("%u") >= 0) return tips("名称不能为中文！", "warning"), !1;
            if ($(".group_editor .tag.this").each(function () {
                for (var e = $(this).attr("data-role").split(";"), t = 0; e.length > t; t++) o[e[t]] = 1
            }), $(".group_editor .add_save").hasClass("hidden")) {
                l = "edit";
                var c = $(".group_editor #role").attr("data-before");
                r = "edit&role_old=" + c + "&role=" + t + "&name=" + i + "&ext_not_allow=" + s
            } else r = "add&role=" + t + "&name=" + i + "&ext_not_allow=" + s;
            $.ajax({
                url: e + r,
                data: o,
                type: "POST",
        ...
        c = function () {
            $(".group a.add").live("click", n), $(".group a.del").live("click", r), $(".group a.edit").live("click", function () {
                var e = $(this).parent().parent();
                s(e.attr("role"))
            }), $(".group_editor a.add_save").live("click", o), $(".group_editor a.edit_save").live("click", o), $(".group_editor a.edit_exit").live("click", n), $(".group_editor a.revert").live("click", function () {
    ...
    var e, t = "index.php?member/",
        ...
        n = function () {
            i = Group.getData(), $.ajax({
                ...
                async: !1,
                success: function (t) {
                    return t.code ? (e = t.data, s(), void 0) : (tips(t), void 0)
                },
                error: function () {
                    return !1
                }
        ...
        s = function () {
            var t = "<tr class='title'><td width=''>" + LNG.username + "</td>" + "<td>" + LNG.group_name + "</td>" + "<td>根目录</td>" + "<td>" + LNG.action + "</td>" + "</tr>",
                n = objectKeys(i);
            a = "";
            ...
            for (var s in e) t += o(e[s].name, e[s].role, e[s].path ? e[s].path : '');
        ...
        o = function (e, t, path) {
            ...
            var s = "<tr name='" + urlDecode(e) + "' role='" + t + "' path='" + path + "'>" + "   <td>" + e + "</td>" + "   <td><a href='javascript:void(0)' class='edit_role'>" + a + "</a></td>" + "<td>" + path + "</td>   <td>" + n + "</td>" + "</tr>";
            return s
        },
        r = function (e, t, i, path) {
            void 0 == t && (t = ""), void 0 == i && (i = ""), void 0 == path && (path = "");
            var n = "";
            n = "add" == e ? {
            ...
            var s = "<tr name='" + t + "' role='" + i + "' path='" + path + "'>" + "   <td class='member'><p>" + LNG.username + ":<input type='text' id='name' value='" + t + "'/></p><p><span>" + LNG.password + ":</span><input type='text' id='password'/></p></td>" + "   <td><select id='role' value='" + i + "'>" + a + "</select></td>" + "<td><input type='text' id='path' style='width:200px' value='" + path + "' /></td>   <td>" + "       <a href='javascript:void(0)' class='button " + n.b1 + "</a>" + "       <a href='javascript:void(0)' class='button " + n.b2 + "</a>" + "   </td>" + "</tr>";
            return s
        },
        l = function () {
            var e = r("add");
        ...
        d = function () {
            var e = $(this).parent().parent(),
                ...
                n = $(e).find("#role").val(),
                path = urlEncode($(e).find("#path").val());
            return "" == a || "" == i || "" == n ? (tips(LNG.not_null, "warning"), !1) : ($.ajax({
                url: t + "add&name=" + a + "&password=" + i + "&role=" + n + '&path=' + path,
                dataType: "json",
                success: function (t) {
                    if (tips(t), t.code) {
                        var i = o(a, n, decodeURIComponent(path));
        ...
        p = function () {
            var e = $(this).parent().parent(),
                t = r("edit", $(e).attr("name"), $(e).attr("role"), $(e).attr('path'));
        ...
        u = function () {
            var e = $(this).parent().parent(),
                t = o($(e).attr("name"), $(e).attr("role"), $(e).attr('path'));
        ...
        h = function () {
            var e = $(this).parent().parent(),
                ...
                n = $(e).find("#role").val(),
                s = urlEncode($(e).find("#password").val()),
                path = urlEncode($(e).find("#path").val());
            if ("" == i || "" == n) return tips(LNG.not_null, "error"), !1;
            var r = "";
            "" != s && (r = "&password_to=" + s), $.ajax({
                url: t + "edit&name=" + a + "&name_to=" + i + "&role_to=" + n + '&path_to=' + path + r,
                dataType: "json",
                success: function (t) {
                    if (tips(t), t.code) {
                        var a = o(i, n, decodeURIComponent(path));
